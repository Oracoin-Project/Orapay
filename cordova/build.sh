...
if [ ! -d $PROJECT ]; then
  ...
  cordova create project com.oracoin.orapay orapay
  checkOK
  cd $PROJECT
  ...
  cordova plugin add https://github.com/cmgustavo/Custom-URL-scheme.git --variable URL_SCHEME=oracoin --variable SECOND_URL_SCHEME=copay
  checkOK
