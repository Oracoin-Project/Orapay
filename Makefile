...
ios-prod:
	...
	open cordova/project/platforms/ios/Oracoin\ Mobile\ Wallet.xcodeproj
...
android-prod:
	...
	jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore orapay.keystore -signedjar cordova/project/platforms/android/build/outputs/apk/android-release-signed.apk  cordova/project/platforms/android/build/outputs/apk/android-release-unsigned.apk orapay
